...
class ProctorAssociationViewSet(BaseModelViewSet):
    queryset = ProctorAssociation.objects.all()
    serializer_class = ProctorAssociationSerializer
    pagination_class = Paginator
    model = 'proctorassociation'
